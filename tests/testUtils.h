...
uint8_t *inTestDataA(uint8_t crc, uint8_t counter) {
	uint8_t temp[8] = { crc,counter & 0x0Fu,0x00,0x00,0x00,0x00,0x00,0x00 };
	memcpy(testdata, temp, sizeof(testdata));
	return testdata;
}
...
uint8_t *inTestDataB(uint8_t crc, uint8_t counter) {
	uint8_t temp[8] = { crc,counter & 0x0Fu,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF };
	memcpy(testdata, temp, sizeof(testdata));
	return testdata;
}
...
uint8_t *inTestDataC(uint8_t crc, uint8_t counter) {
	uint8_t temp[8] = { crc,counter & 0x0Fu,0x02,0x03,0x04,0x05,0x06,0x07 };
	memcpy(testdata, temp, sizeof(testdata));
	return testdata;
}
